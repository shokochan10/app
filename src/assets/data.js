...
export const SIDEBAR_LINKS = [
  ...
  { name: 'Campaigns', icon: 'envelope-o' },
  { name: 'Workflows', icon: 'calendar' },
  { name: 'Templates', icon: 'folder-open-o' },
  { name: 'Stats', icon: 'bar-chart' },
  { name: 'Contacts', icon: 'group' },
  { name: 'Surveys', icon: 'server' },
];
